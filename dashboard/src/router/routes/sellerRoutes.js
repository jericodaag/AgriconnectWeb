...
const ProductAnalytics = lazy(() => import('../../views/seller/ProductAnalytics'))
const InventoryHistory = lazy(() => import('../../views/seller/InventoryHistory'))
...
export const sellerRoutes = [
    ...
    {
        path: '/seller/dashboard/inventory-history/:productId',
